...
ali_dir=exp/en_2300h_tri6b_cleaned_ali
#dir=exp/nnet3${nnet3_affix}/tdnn${affix:+_$affix}_sp
#dir=exp/nnet3_cleaned/tdnn_1c
dir=exp/nnet3_en_2300/
#train_data_dir=data/${train_set}
train_data_dir=data/en_2300h_16k
...
if [ $stage -le 12 ]; then
  ...
  steps/nnet3/train_dnn.py --stage=$train_stage \
    ...
    --trainer.optimization.initial-effective-lrate 0.0012 \
    --trainer.optimization.final-effective-lrate 0.00012 \
