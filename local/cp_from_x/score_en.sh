...
ref_filtering_cmd="local/wer_output_filter.orign"
hyp_filtering_cmd="local/wer_output_filter.orign"
  ...
  for wip in $(echo $word_ins_penalty | sed 's/,/ /g'); do
    ...
    if $decode_mbr ; then
      $cmd LMWT=$min_lmwt:$max_lmwt $dir/scoring_kaldi/penalty_$wip/log/best_path.LMWT.log \
        ...
        $hyp_filtering_cmd \| sort -u '>' $dir/scoring_kaldi/penalty_$wip/LMWT.txt || exit 1;
    ...
    $cmd LMWT=$min_lmwt:$max_lmwt $dir/scoring_kaldi/penalty_$wip/log/score.LMWT.log \
      cat $dir/scoring_kaldi/penalty_$wip/LMWT.txt \| sort -u \| \
